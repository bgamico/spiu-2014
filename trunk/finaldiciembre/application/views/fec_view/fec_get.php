					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse"
							...
							<form class="navbar-form navbar-right" role="search">
								<?= anchor('fecha/add', 'Agregar', array('class'=>'btn btn-default')); ?>
							</form>
						</div>
					</div>
				</nav>
				...
				<table id="tabla" class="table table-striped table-hover table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td><?= anchor('fecha/edit/'.$registro->id, '<i class="glyphicon glyphicon-pencil"></i>',array('class'=>'view')); ?>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<?= anchor('fecha/delete/'.$registro->id,'Borrar',array('class'=>"btn btn-danger danger"))?>
