...
<div class="col-lg-9 offset1">
	<div class="well bs-component">
		...
		<?= form_open('backend/actividad/insert', array('class'=>'form-horizontal','id'=>'contact-form')); ?>
		<fieldset>
			...
			<div class="form-group">
				<div class="control-group">
					...
					<div class="col-lg-9">
						<?= form_input(array('type'=>'text', 'class'=>"form-control", 'name'=>'nombre', 'id'=>'nombre', 'placeholder'=>'Nombre de actividad', 'value'=>set_value('nombre'))); ?>
			...
			<div class="form-group">
				<div class="col-lg-9 col-lg-offset-3">
					...
					<?= anchor('backend/actividad', 'Cancelar', array('class'=>'btn btn-default')); ?>
				</div>
			</div>
		</fieldset>
		<?= form_close(); ?>
