...
class Fecha extends CI_Controller
{
	...
	function index()
	{
		...
		$this->load->view('backend/fec_view/fec_get', $data);
	...
	function edit($id)
	{
		...
		$this->load->view('backend/include/header');
		$this->load->view('backend/include/nav');
		$this->load->view('backend/fec_view/fec_edit',$data);
		$this->load->view('backend/include/footer');
	}
	...
	function add()
	{
		...
		$this->load->view('backend/include/header');
		$this->load->view('backend/include/nav');
		$this->load->view('backend/fec_view/fec_add');
		$this->load->view('backend/include/footer');
	}
